...
//$Code		=	'ISEC2017CPU123';
//$Group		=	10;
$AssetTypeArray		=	array('CPU'=>3,'THK'=>3,'NOT'=>4,'LAP'=>4);
//$ValidGroupArray	=	array('ICI'=>7,'BOR'=>1,'HFC'=>9,'WEB'=>6,'LGI'=>12,'PLI'=>13,'ISEC'=>14,'IFIG'=>10,'TMP'=>7,'TEMP'=>10);
...
if($name){
	...
	$query = "SELECT * FROM `glpi_computers` where ".$Field."='".trim($name)."'";
