...
//          "</script>";
   ...
   echo "<body>";
   echo "<div id='firstboxlogin' style='background:url(pics/ensuring-customer-satisfaction-2.jpg) 50% 87px no-repeat'>";
 ...
 echo "<div id='header_top' style='float:left; width:100%; height:87px; border-bottom:3px solid #264796;'>
	  <div style='width:1170px; margin:0px auto;'><img src='pics/vara-logo.png' style='float:left;'><h3 style='float:left; color:#264796; font-size:25px; font-weight:bold; margin-top:26px; margin-left:15px;'>Enterprise Asset Management System</h3></div>
	  </div>";
	  
	   
   echo "<div id='logo_login' style='display:none;'></div>";
  
     echo "<div id='boxlogin' style='margin-top:180px;margin-right:100px'>";
 
   echo "<div id='div1' style='width:400px; color:#fff;'><h1>Login</h1>";
   ...
   echo '<p class="login_input">
         <input type="submit" style="background-color:#F68B1F" name="submit" value="'._sx('button','Post').'" class="submit" />
         </p>';
